...
\name{Wissam}{Antoun}
\position{Machine Learning Scientist{\enskip\cdotp\enskip}Graduate Researcher}
\address{Beirut, Lebanon}

\Huge
\mobile{(+961) 71-778924}
\email{wissam.antoun@gmail.com}
\homepage{wissamantoun.github.io}
%\github{WissamAntoun}
\linkedin{wissamantoun}
% \gitlab{gitlab-id}
...
\googlescholar{fEgsyU4AAAAJ}{Wissam Antoun}
